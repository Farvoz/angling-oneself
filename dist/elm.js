...
var $author$project$Model$MainMenu = {$: 'MainMenu'};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Model$init = function (_v0) {
	return _Utils_Tuple2(
		{appPhase: $author$project$Model$MainMenu, gameState: $elm$core$Maybe$Nothing},
...
var $author$project$Model$InGame = {$: 'InGame'};
var $author$project$Model$ShuffledDecks = function (a) {
	return {$: 'ShuffledDecks', a: a};
};
...
var $author$project$GameModel$Playing = {$: 'Playing'};
var $author$project$GameModel$BaitCard = function (a) {
	return {$: 'BaitCard', a: a};
};
var $author$project$GameModel$BottomRight = {$: 'BottomRight'};
var $author$project$GameModel$MiddleLeft = {$: 'MiddleLeft'};
var $author$project$GameModel$MiddleRight = {$: 'MiddleRight'};
var $author$project$GameModel$TerrainCard = function (a) {
	return {$: 'TerrainCard', a: a};
};
var $author$project$GameModel$TopLeft = {$: 'TopLeft'};
var $author$project$GameModel$TopRight = {$: 'TopRight'};
var $author$project$GameModel$initialConductingDeck = _List_fromArray(
	[
		$author$project$GameModel$TerrainCard(
		{notchPosition: $author$project$GameModel$TopRight, notchStrength: 1, tension: 1}),
		$author$project$GameModel$TerrainCard(
		{notchPosition: $author$project$GameModel$MiddleRight, notchStrength: 1, tension: 1}),
		$author$project$GameModel$TerrainCard(
		{notchPosition: $author$project$GameModel$BottomRight, notchStrength: 1, tension: 1}),
		$author$project$GameModel$TerrainCard(
		{notchPosition: $author$project$GameModel$TopRight, notchStrength: 1, tension: -1}),
		$author$project$GameModel$TerrainCard(
		{notchPosition: $author$project$GameModel$MiddleRight, notchStrength: 1, tension: -1}),
		...
		{notchPosition: $author$project$GameModel$MiddleRight, notchStrength: 1, tension: 1}),
		$author$project$GameModel$TerrainCard(
		{notchPosition: $author$project$GameModel$TopRight, notchStrength: 1, tension: 2}),
		$author$project$GameModel$BaitCard(
		{
			notches: _List_fromArray(
				[
					_Utils_Tuple2($author$project$GameModel$TopLeft, 1),
					_Utils_Tuple2($author$project$GameModel$MiddleLeft, 1)
				])
		})
	]);
var $author$project$GameModel$LoosenDrag = function (a) {
	return {$: 'LoosenDrag', a: a};
};
var $author$project$GameModel$Maneuver = function (a) {
	return {$: 'Maneuver', a: a};
};
var $author$project$GameModel$Strike = function (a) {
	return {$: 'Strike', a: a};
};
var $author$project$GameModel$initialTechniquesDeck = _List_fromArray(
	[
		$author$project$GameModel$Strike(1),
		$author$project$GameModel$Strike(1),
		$author$project$GameModel$Strike(1),
		$author$project$GameModel$Maneuver(-1),
		$author$project$GameModel$Maneuver(-1),
		$author$project$GameModel$Maneuver(-1),
		$author$project$GameModel$LoosenDrag(1),
		$author$project$GameModel$LoosenDrag(1)
	]);
...
var $author$project$GameModel$swap = F3(
	function (array, i, j) {
		var _v0 = _Utils_Tuple2(
			A2($elm$core$Array$get, i, array),
			A2($elm$core$Array$get, j, array));
		if ((_v0.a.$ === 'Just') && (_v0.b.$ === 'Just')) {
			...
			return A3(
				...
				j,
				a,
				A3($elm$core$Array$set, i, b, array));
		} else {
			return array;
		}
	});
var $author$project$GameModel$shuffleArray = F4(
	function (seed, array, currentIndex, length) {
		shuffleArray:
		while (true) {
			if (_Utils_cmp(currentIndex, length) > -1) {
				return _Utils_Tuple2(
				...
				var newSeed = _v0.b;
				var swappedArray = A3($author$project$GameModel$swap, array, currentIndex, randomIndex);
				var $temp$seed = newSeed,
					$temp$array = swappedArray,
				...
				length = $temp$length;
				continue shuffleArray;
			}
		}
	});
var $author$project$GameModel$shuffleList = F2(
	function (seed, list) {
		var length = $elm$core$List$length(list);
		var array = $elm$core$Array$fromList(list);
		return A4($author$project$GameModel$shuffleArray, seed, array, 0, length);
	});
var $author$project$GameModel$initialGameState = function (seed) {
	var _v0 = A2($author$project$GameModel$shuffleList, seed, $author$project$GameModel$initialConductingDeck);
	var shuffledConducting = _v0.a;
	var seed1 = _v0.b;
	var _v1 = A2($author$project$GameModel$shuffleList, seed1, $author$project$GameModel$initialTechniquesDeck);
	var shuffledTechniques = _v1.a;
	return {caughtFish: 0, conductingDeck: shuffledConducting, discardedTerrainCards: _List_Nil, lineTension: 0, openTechniqueCards: _List_Nil, openTerrainCards: _List_Nil, phase: $author$project$GameModel$Playing, techniquesDeck: shuffledTechniques, timeElapsed: 0};
};
var $elm$random$Random$maxInt = 2147483647;
var $elm$random$Random$minInt = -2147483648;
var $author$project$GameModel$Lost = {$: 'Lost'};
var $author$project$GameModel$Won = {$: 'Won'};
...
var $author$project$GameModel$checkBaitVictory = F3(
	function (lineTension, openTerrainCards, baitCard) {
		var _v0 = _Utils_Tuple2(
			baitCard,
			$elm$core$List$reverse(openTerrainCards));
		if ((_v0.a.$ === 'BaitCard') && _v0.b.b) {
			var notches = _v0.a.a.notches;
			var _v1 = _v0.b;
			var lastCard = _v1.a;
			if (lastCard.$ === 'TerrainCard') {
				var notchPosition = lastCard.a.notchPosition;
				var notchStrength = lastCard.a.notchStrength;
				var hasMatchingPosition = A2(
					$elm$core$List$any,
					function (_v3) {
						var pos = _v3.a;
						return _Utils_eq(pos, notchPosition);
					},
					notches);
				return hasMatchingPosition && _Utils_eq(lineTension, notchStrength);
			} else {
				return false;
			}
		} else {
...
var $author$project$GameModel$drawCard = function (deck) {
	if (!deck.b) {
...
var $author$project$GameModel$shuffleAndPrepend = F3(
	function (seed, cardsToShuffle, deck) {
		var _v0 = A2($author$project$GameModel$shuffleList, seed, cardsToShuffle);
		var shuffled = _v0.a;
		var newSeed = _v0.b;
		return _Utils_Tuple2(
			_Utils_ap(shuffled, deck),
			newSeed);
	});
var $author$project$GameModel$updateGame = F2(
	function (msg, gameState) {
		switch (msg.$) {
			case 'Pull':
				if (!_Utils_eq(gameState.phase, $author$project$GameModel$Playing)) {
					return gameState;
				} else {
					var _v1 = $author$project$GameModel$drawCard(gameState.conductingDeck);
					var newDeck = _v1.a;
					var maybeCard = _v1.b;
					if (maybeCard.$ === 'Nothing') {
						return _Utils_update(
							gameState,
							{phase: $author$project$GameModel$Lost});
					} else {
						var card = maybeCard.a;
						if (card.$ === 'TerrainCard') {
							var tension = card.a.tension;
							var newTension = gameState.lineTension + tension;
							var newOpenCards = _Utils_ap(
								gameState.openTerrainCards,
								_List_fromArray(
									[card]));
							return _Utils_update(
								gameState,
								{conductingDeck: newDeck, lineTension: newTension, openTerrainCards: newOpenCards});
						} else {
							var isVictory = A3($author$project$GameModel$checkBaitVictory, gameState.lineTension, gameState.openTerrainCards, card);
							var newPhase = isVictory ? $author$project$GameModel$Won : $author$project$GameModel$Playing;
							return _Utils_update(
								gameState,
								{
									conductingDeck: newDeck,
									openTerrainCards: _Utils_ap(
										gameState.openTerrainCards,
										_List_fromArray(
											[card])),
									phase: newPhase
			...
			case 'StayHere':
				if ($elm$core$List$length(gameState.openTerrainCards) === 5) {
					var seed = $elm$random$Random$initialSeed(
						gameState.timeElapsed + $elm$core$List$length(gameState.openTerrainCards));
					var _v4 = A3($author$project$GameModel$shuffleAndPrepend, seed, gameState.openTerrainCards, gameState.conductingDeck);
					var shuffledCards = _v4.a;
					return _Utils_update(
						gameState,
						{conductingDeck: shuffledCards, openTerrainCards: _List_Nil});
				} else {
					return gameState;
				}
			case 'SearchNewPlace':
				return ($elm$core$List$length(gameState.openTerrainCards) === 5) ? _Utils_update(
					gameState,
					{
						discardedTerrainCards: _Utils_ap(gameState.discardedTerrainCards, gameState.openTerrainCards),
						openTerrainCards: _List_Nil
					}) : gameState;
			default:
				var shuffledCards = msg.a;
				return _Utils_update(
					gameState,
					{
						conductingDeck: _Utils_ap(shuffledCards, gameState.conductingDeck),
						openTerrainCards: _List_Nil
					});
		}
	});
		...
		switch (msg.$) {
			case 'StartNewGame':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{appPhase: $author$project$Model$InGame, gameState: $elm$core$Maybe$Nothing}),
					A2(
						$elm$random$Random$generate,
						$author$project$Model$ShuffledDecks,
						A2($elm$random$Random$int, $elm$random$Random$minInt, $elm$random$Random$maxInt)));
			case 'ShuffledDecks':
				var seedValue = msg.a;
				var gameState = $author$project$GameModel$initialGameState(
				...
				if (_v1.$ === 'Just') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								gameState: $elm$core$Maybe$Just(
									A2($author$project$GameModel$updateGame, gameMsg, gameState))
							}),
						$elm$core$Platform$Cmd$none);
				} else {
...
var $author$project$Styles$surfacePage = $rtfeldman$elm_css$Css$hex('eef4f8');
var $author$project$Styles$textPrimary = $rtfeldman$elm_css$Css$hex('1e3a3f');
		...
		[
			...
			_List_fromArray(
				[
					...
					$rtfeldman$elm_css$Css$padding($rtfeldman$elm_css$Css$zero),
					$rtfeldman$elm_css$Css$margin($rtfeldman$elm_css$Css$zero),
					$rtfeldman$elm_css$Css$backgroundColor($author$project$Styles$surfacePage),
...
var $author$project$Styles$rootStyle = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			$rtfeldman$elm_css$Css$height(
			$rtfeldman$elm_css$Css$pct(100)),
...
var $author$project$Model$Restart = {$: 'Restart'};
...
var $author$project$Styles$surfaceMuted = $rtfeldman$elm_css$Css$hex('b8c9c4');
var $author$project$Styles$btnStyle = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			...
			$rtfeldman$elm_css$Css$backgroundColor($author$project$Styles$surfaceMuted),
			$rtfeldman$elm_css$Css$color($author$project$Styles$textPrimary)
		]));
...
var $author$project$Styles$semanticError = $rtfeldman$elm_css$Css$hex('b84a4a');
var $author$project$Styles$semanticSuccess = $rtfeldman$elm_css$Css$hex('1a6b4a');
...
var $author$project$Styles$borderMuted = $rtfeldman$elm_css$Css$hex('7a9a8e');
var $rtfeldman$elm_css$Css$borderRadius = $rtfeldman$elm_css$Css$prop1('border-radius');
var $author$project$Styles$cardSize = $rtfeldman$elm_css$Css$px(48);
var $author$project$Styles$cardHeight = $rtfeldman$elm_css$Css$height($author$project$Styles$cardSize);
var $rtfeldman$elm_css$Css$width = $rtfeldman$elm_css$Css$prop1('width');
var $author$project$Styles$cardWidth = $rtfeldman$elm_css$Css$width($author$project$Styles$cardSize);
...
var $author$project$Styles$cardSlotStyle = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			$author$project$Styles$cardWidth,
			$author$project$Styles$cardHeight,
			A3(
			$rtfeldman$elm_css$Css$border3,
			$rtfeldman$elm_css$Css$px(2),
			$rtfeldman$elm_css$Css$dashed,
			$author$project$Styles$borderMuted),
			$rtfeldman$elm_css$Css$borderRadius(
			$rtfeldman$elm_css$Css$px(6)),
			$author$project$Styles$flexCenter,
			$rtfeldman$elm_css$Css$backgroundColor($author$project$Styles$surfaceMuted)
		]));
var $author$project$Styles$borderDefault = $rtfeldman$elm_css$Css$hex('2d5a52');
var $rtfeldman$elm_css$Css$solid = {borderStyle: $rtfeldman$elm_css$Css$Structure$Compatible, textDecorationStyle: $rtfeldman$elm_css$Css$Structure$Compatible, value: 'solid'};
var $author$project$Styles$surfaceAccent = $rtfeldman$elm_css$Css$hex('d4a84b');
var $author$project$Styles$textOnAccent = $rtfeldman$elm_css$Css$hex('1e2a1a');
var $author$project$Styles$cardBaitStyle = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			$author$project$Styles$cardWidth,
			$author$project$Styles$cardHeight,
			...
			$author$project$Styles$borderDefault),
			$rtfeldman$elm_css$Css$borderRadius(
			$rtfeldman$elm_css$Css$px(6)),
			$author$project$Styles$flexCenter,
			$rtfeldman$elm_css$Css$backgroundColor($author$project$Styles$surfaceAccent),
			$rtfeldman$elm_css$Css$color($author$project$Styles$textOnAccent),
			$rtfeldman$elm_css$Css$fontSize(
			$rtfeldman$elm_css$Css$rem(0.75))
		]));
var $rtfeldman$elm_css$Css$position = $rtfeldman$elm_css$Css$prop1('position');
var $rtfeldman$elm_css$Css$relative = {position: $rtfeldman$elm_css$Css$Structure$Compatible, value: 'relative'};
var $author$project$Styles$surfaceDefault = $rtfeldman$elm_css$Css$hex('d8e6e8');
var $author$project$Styles$cardTerrainStyle = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			$author$project$Styles$cardWidth,
			$author$project$Styles$cardHeight,
			...
			$author$project$Styles$flexCenter,
			$rtfeldman$elm_css$Css$backgroundColor($author$project$Styles$surfaceDefault),
			$rtfeldman$elm_css$Css$color($author$project$Styles$textPrimary),
			$rtfeldman$elm_css$Css$fontSize(
...
var $author$project$ViewGameElements$notchPositionStyles = function (position) {
	switch (position.$) {
		case 'TopLeft':
			return _List_fromArray(
				[
...
var $author$project$Styles$textOnDark = $rtfeldman$elm_css$Css$hex('ffffff');
var $author$project$Styles$notchStyle = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			...
			$rtfeldman$elm_css$Css$height(
			$rtfeldman$elm_css$Css$px(6)),
			$rtfeldman$elm_css$Css$backgroundColor($author$project$Styles$borderDefault),
			$rtfeldman$elm_css$Css$borderRadius(
			$rtfeldman$elm_css$Css$pct(50)),
			$author$project$Styles$flexCenter,
			$rtfeldman$elm_css$Css$fontSize(
			$rtfeldman$elm_css$Css$rem(0.45)),
			$rtfeldman$elm_css$Css$color($author$project$Styles$textOnDark)
		]));
var $author$project$ViewGameElements$viewNotch = F2(
	function (position, strength) {
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(
						$elm$core$List$cons,
						$author$project$Styles$notchStyle,
						$author$project$ViewGameElements$notchPositionStyles(position)))
				]),
			_List_fromArray(
				[
...
var $author$project$ViewGameElements$viewTerrainCard = function (card) {
	if (card.$ === 'TerrainCard') {
		var tension = card.a.tension;
		var notchPosition = card.a.notchPosition;
		var notchStrength = card.a.notchStrength;
		return A2(
			$rtfeldman$elm_css$Html$Styled$div,
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Attributes$css(
					_List_fromArray(
						[$author$project$Styles$cardTerrainStyle]))
				]),
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$text(
					$elm$core$String$fromInt(tension)),
					A2($author$project$ViewGameElements$viewNotch, notchPosition, notchStrength)
				]));
	} else {
		return A2(
			$rtfeldman$elm_css$Html$Styled$div,
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Attributes$css(
					_List_fromArray(
						[$author$project$Styles$cardBaitStyle]))
				]),
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$text('Наживка')
				]));
	}
};
var $author$project$ViewGameElements$viewCardSlot = function (maybeCard) {
	if (maybeCard.$ === 'Just') {
		var card = maybeCard.a;
		return $author$project$ViewGameElements$viewTerrainCard(card);
	} else {
		return A2(
			$rtfeldman$elm_css$Html$Styled$div,
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Attributes$css(
					_List_fromArray(
						[$author$project$Styles$cardSlotStyle]))
				]),
			_List_Nil);
	}
};
var $author$project$ViewGameElements$viewOpenTerrainCards = function (cards) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						$rtfeldman$elm_css$Css$flexDirection($rtfeldman$elm_css$Css$column),
						$rtfeldman$elm_css$Css$alignItems($rtfeldman$elm_css$Css$center),
						A2($rtfeldman$elm_css$Css$property, 'gap', '4px'),
		...
		A2(
			$elm$core$List$map,
			function (i) {
				return $author$project$ViewGameElements$viewCardSlot(
					$elm$core$List$head(
						A2($elm$core$List$drop, i, cards)));
			},
			A2($elm$core$List$range, 0, 4)));
};
var $author$project$ViewGameElements$viewGameBoard = function (cards) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$author$project$ViewGameElements$viewOpenTerrainCards(cards)
			]));
};
var $author$project$Model$GameMsg = function (a) {
	return {$: 'GameMsg', a: a};
};
var $author$project$GameModel$Pull = {$: 'Pull'};
var $author$project$GameModel$SearchNewPlace = {$: 'SearchNewPlace'};
var $author$project$GameModel$StayHere = {$: 'StayHere'};
...
var $author$project$ViewHud$viewHudActions = function (gameState) {
	return ($elm$core$List$length(gameState.openTerrainCards) === 5) ? A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$Attributes$css(
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Model$GameMsg($author$project$GameModel$StayHere)),
						$rtfeldman$elm_css$Html$Styled$Attributes$css(
						_List_fromArray(
							[$author$project$Styles$btnStyle]))
					]),
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('Остаться здесь')
					])),
				A2(
				$rtfeldman$elm_css$Html$Styled$button,
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Events$onClick(
						$author$project$Model$GameMsg($author$project$GameModel$SearchNewPlace)),
						$rtfeldman$elm_css$Html$Styled$Attributes$css(
						_List_fromArray(
							[$author$project$Styles$btnStyle]))
					]),
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('Поискать новое место')
					]))
			])) : A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
		...
		_List_fromArray(
			[
				(($elm$core$List$length(gameState.openTerrainCards) < 5) && (!$elm$core$List$isEmpty(gameState.conductingDeck))) ? A2(
				$rtfeldman$elm_css$Html$Styled$button,
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Events$onClick(
						$author$project$Model$GameMsg($author$project$GameModel$Pull)),
						$rtfeldman$elm_css$Html$Styled$Attributes$css(
						_List_fromArray(
							[$author$project$Styles$btnStyle]))
					]),
...
var $author$project$ViewHud$viewHudStats = function (gameState) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$text(
				'Натяжение: ' + ($elm$core$String$fromInt(gameState.lineTension) + (' | Рыб: ' + ($elm$core$String$fromInt(gameState.caughtFish) + (' | Время: ' + ($elm$core$String$fromInt(gameState.timeElapsed) + (' | Карт в колоде: ' + $elm$core$String$fromInt(
					$elm$core$List$length(gameState.conductingDeck)))))))))
			]));
};
var $author$project$View$viewGame = function (gameState) {
	var _v0 = gameState.phase;
	switch (_v0.$) {
		case 'Won':
			return A2(
				$rtfeldman$elm_css$Html$Styled$div,
				...
				_List_fromArray(
					[
							...
							[
								...
								_List_fromArray(
									[
										...
										$rtfeldman$elm_css$Css$fontWeight($rtfeldman$elm_css$Css$bold),
										$rtfeldman$elm_css$Css$color($author$project$Styles$semanticSuccess),
										$rtfeldman$elm_css$Css$marginBottom(
										$rtfeldman$elm_css$Css$rem(1))
									]))
							]),
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text('Победа!')
							])),
						A2(
						$rtfeldman$elm_css$Html$Styled$div,
						_List_fromArray(
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text(
								'Натяжение: ' + ($elm$core$String$fromInt(gameState.lineTension) + (' | Рыб: ' + ($elm$core$String$fromInt(gameState.caughtFish) + (' | Время: ' + $elm$core$String$fromInt(gameState.timeElapsed))))))
							])),
						A2(
						$rtfeldman$elm_css$Html$Styled$button,
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$Model$Restart),
								$rtfeldman$elm_css$Html$Styled$Attributes$css(
								_List_fromArray(
									[$author$project$Styles$btnStyle]))
							]),
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text('Начать заново')
							]))
					]));
		case 'Lost':
			return A2(
				...
				_List_fromArray(
					[
							...
							[
								...
								_List_fromArray(
									[
										...
										$rtfeldman$elm_css$Css$rem(2)),
										$rtfeldman$elm_css$Css$fontWeight($rtfeldman$elm_css$Css$bold),
										$rtfeldman$elm_css$Css$color($author$project$Styles$semanticError),
										$rtfeldman$elm_css$Css$marginBottom(
										$rtfeldman$elm_css$Css$rem(1))
									]))
							]),
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text('Поражение')
							])),
						A2(
						$rtfeldman$elm_css$Html$Styled$div,
						_List_fromArray(
		...
		default:
			return A2(
				...
				_List_fromArray(
					[
						$author$project$ViewHud$viewHudStats(gameState),
						$author$project$ViewGameElements$viewGameBoard(gameState.openTerrainCards),
						$author$project$ViewHud$viewHudActions(gameState)
					]));
	}
};
var $author$project$Model$StartNewGame = {$: 'StartNewGame'};
var $author$project$View$viewMainMenu = A2(
	$rtfeldman$elm_css$Html$Styled$div,
	_List_fromArray(
		[
			$rtfeldman$elm_css$Html$Styled$Attributes$css(
			_List_fromArray(
				[$author$project$Styles$flexColumn, $author$project$Styles$flexCenter]))
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$text('Главное меню')
				])),
			A2(
			$rtfeldman$elm_css$Html$Styled$button,
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$Model$StartNewGame),
					$rtfeldman$elm_css$Html$Styled$Attributes$css(
					_List_fromArray(
						[$author$project$Styles$btnStyle]))
				]),
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$text('Новая игра')
				]))
		]));
	...
	return A2(
		...
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$Attributes$css(
				_List_fromArray(
					[$author$project$Styles$rootStyle]))
			]),
		_List_fromArray(
			[
				$author$project$Styles$globalStyles,
				function () {
				var _v0 = model.appPhase;
				if (_v0.$ === 'MainMenu') {
					return $author$project$View$viewMainMenu;
				} else {
					var _v1 = model.gameState;
					if (_v1.$ === 'Nothing') {
						return A2(
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$text('Загрузка...')
								]));
					} else {
						var gameState = _v1.a;
						return $author$project$View$viewGame(gameState);
					}
				}
			}()
			]));
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{
		...
		update: $author$project$Model$update,
